...
class RecentSearchSupportTest {
    ...
    private val podgorica = StopEntity(
        stopId = 8,
        nameEn = "Podgorica",
        nameMe = "Podgorica",
        nameMeCyr = "Подгорица",
    ...
    private val bijeloPolje = StopEntity(
        stopId = 22,
        nameEn = "Bijelo Polje",
        nameMe = "Bijelo Polje",
    ...
    fun upsertRecentSearch_movesDuplicatePairToTop() {
        ...
        val updated = upsertRecentSearch(
            existing = existing,
            fromStop = bar,
            toStop = podgorica,
            searchedAtMs = 300L
    ...
    fun resolveRecentSearchLabel_prefersStopIdAndRequestedLanguage() {
        val label = resolveRecentSearchLabel(
